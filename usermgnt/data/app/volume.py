...
def save_device_id(device_id):
    try:
        LOG.trace("[usermgnt.data.app.volume] [save_device_id] Storing 'device_id' [" + device_id + "] value in local VOLUME [" + config.dic['UM_WORKING_DIR_VOLUME'] + "] ...")
...
# read_device_id
def read_device_id():
    LOG.trace("[usermgnt.data.app.volume] [read_device_id] Reading 'device_id' value from local VOLUME [" + config.dic['UM_WORKING_DIR_VOLUME'] + "] ...")
    try:
...
def save_user_id(user_id):
    try:
        LOG.trace("[usermgnt.app.volume] [save_user_id] Storing user_id [" + user_id + "] value in local VOLUME [" + config.dic['UM_WORKING_DIR_VOLUME'] + "] ...")
...
# read_user_id
def read_user_id():
    LOG.trace("[usermgnt.data.app.volume] [read_user_id] Reading user_id value from local VOLUME [" + config.dic['UM_WORKING_DIR_VOLUME'] + "] ...")
    try:
